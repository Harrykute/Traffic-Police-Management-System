...
if(request.getParameter("success")!=null){
	out.println("<script>alert('Complaint has been Activated successfully.')</script>");
}
%>
		...
		<div align="center">
			...
			<%
				...
				PreparedStatement ps = con
						.prepareStatement("SELECT * from user_info ");
			...
			<table border="1">
				...
				<tr>
					...
					<td><a href="userDetails.jsp?userId=<%=rs.getString("id")%>">View</a></td>
				</tr>
				<%
					}
				%>
