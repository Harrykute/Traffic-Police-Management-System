	...
	<div class="wrapper header">
		<div class="clearfix header_top">
			<div class="clearfix logo floatleft">
				<h1 style="color: white; font-size: xx-large;">Document Verification and Stolen Vehicle Detection using QR Cod</h1>
			</div>
		...
		<div class="header_bottom">
			<ul id="nav">
				...
				<li><a href="Login.jsp">Showroom Admin</a></li>
				...
				<table cellpadding="5" cellspacing="5">
					<tr>
						...
						<td><input type="text" name="email"
							style="width: 170px; height: 20px"></td>
					</tr>
					<tr>
						<td>Password</td>
